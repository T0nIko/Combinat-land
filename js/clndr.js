    ...
    var clndrTemplate =
        "<div class='clndr-controls'>" +
            "<div class='clndr-control-button'>" +
                "<span class='clndr-previous-button'><img src='assets/pictures/svg/arrow-brown.svg' class='clndr-previous-button-img prev' /></span>" +
            "</div>" +
            "<div class='month'><%= month %> <%= year %></div>" +
            "<div class='clndr-control-button rightalign'>" +
                "<span class='clndr-next-button'><img src='assets/pictures/svg/arrow-brown.svg' class='clndr-previous-button-img' /></span>" +
            "</div>" +
        "</div>" +
