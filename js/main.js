...
function onScroll(){
    ...
    $(menu_selector + " a").each(function(){
        ...
        var target = $(hash);
        if (target.position().top <= scroll_top && target.position().top + target.outerHeight() > scroll_top - 300) {
            $(menu_selector + " a.aside-nav--active").removeClass("aside-nav--active");
            $(this).addClass("aside-nav--active");
        } else {
            $(this).removeClass("aside-nav--active");
        }
    });
}
/*$(document).ready(function () {
